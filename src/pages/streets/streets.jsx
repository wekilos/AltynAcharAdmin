...
const Streets = () => {
  ...
  const { data, error, isLoading } = useGetAllStreetsQuery(search);
    ...
    <div className="w-full">
      ...
      <div className="w-full pb-[30px] flex justify-between items-center">
        ...
        <div className="w-fit flex gap-5">
          <Button
            onClick={() => history.push({ pathname: "/streets/create" })}
          ...
          return loading ? (
            ...
            >
              ...
              <h1 className="text-[14px] flex items-center justify-between gap-4 font-[500] text-[#98A2B2] w-[15%] uppercase">
                <div
                  onClick={() =>
                    history.push({ pathname: "/streets/" + item?.id })
                  }
...
export default React.memo(Streets);
