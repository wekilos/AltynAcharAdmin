...
const AutoMessageUpdate = () => {
  ...
  const createcategory = async () => {
    ...
    try {
      await updateAutoReply({ id: id, body: sms }).unwrap();
      history.goBack();
    } catch (err) {
      ...
      <div className="w-full min-h-[60vh] p-5 bg-white rounded-[8px]">
        ...
        <div className="flex items-center border-t-[1px] justify-between py-[30px]">
          <div className="w-[380px]">
            <h1 className="text-[18px] font-[500]">Auto SMS</h1>
        ...
        <div className="flex items-center border-t-[1px] justify-between py-[30px]">
          ...
          <div className="flex justify-start w-[550px]">
            <input
              value={sms.reply}
              onChange={(e) => {
                setSms({ ...sms, reply: e.target.value });
              }}
              className="text-[14px] w-full text-black font-[400]  border-[1px] border-[#98A2B2] rounded-[6px] px-5 py-3 outline-none "
...
export default React.memo(AutoMessageUpdate);
