...
import { useGetAllMessageSentsQuery } from "../../services/messageSend";
  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full pb-[30px] flex justify-between items-center">
        <h1 className="text-[30px] font-[700]"> SMS Ugradylan</h1>
        <div className="w-fit flex gap-5">
          <Button
            onClick={() => history.push({ pathname: "/messageSend/create" })}
      ...
      <div className="w-full p-5 bg-white rounded-[8px]">
        ...
        <div className="w-full gap-[30px] flex items-center px-4 h-[40px] rounded-[6px] bg-[#F7F8FA]">
          ...
          <h1 className="text-[14px] font-[500] text-[#98A2B2] w-[15%] min-w-[120px] whitespace-nowrap uppercase">
            Wagty
          </h1>
        ...
        {data?.data?.messages?.map((item, i) => {
          return loading ? (
            ...
            >
              ...
              <h1 className="text-[14px] font-[500] text-black w-[15%] min-w-[120px]  uppercase">
              ...
              <h1 className="text-[14px] flex items-center justify-between gap-4 font-[500] text-[#98A2B2] w-[20%] uppercase">
                ...
                >
                  {item?.status != "sending" ? item?.status : item?.status}
                </div>
                <div
                  onClick={() =>
                    history.push({ pathname: "/messageSend/" + item?.id })
                  }
        ...
        {selecteds?.length == 0 ? (
          <div className="w-full flex mt-5 justify-between items-center">
            <h1 className="text-[14px] font-[400]">
              {data?.data?.messages?.length} Ugradylan SMS
            </h1>
            <Pagination
              meta={categories?.meta}
              pages={pages}
              pageNo={filter.page}
              length={data?.data?.messages?.length}
